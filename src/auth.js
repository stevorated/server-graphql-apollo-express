...
export const signedIn = req => {
  console.log(req.session.passport.userId)
  console.log(req.session.userId, req.session.passport.userId)
  return req.session.userId || req.session.passport._json.userId
}
